...
<div class="card px-5 py-5" style="margin:auto;width:50%" >
    <div class="card-header">Create your application here</div>
    @if($errors->any())
...
<form method="POST" action="{{route('students.store')}}">
    ...
    <input class="form-control mt-3" type="text" placeholder="Comment" name="fee" required>
    <input type="submit" class="btn btn-primary mt-4"  value="Submit Application" />
